  ...
  render() {
    return (
            <div>
             ...
             <p>Now since we arranged everything for the wedding lets create the invitatin card so we can send it to you'r guests! </p>
            <br/>
            <div className="card">
            ...
            <div className="form-group">
             <input type="createcard" className="btn btn-primary" value="Create Wedding Card"/>
            </div>
            </form>
            </div>
            </div>
